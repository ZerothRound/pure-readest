...
- `apps/readest-app/workers`
  Worker-side backend code outside the normal page UI tree. Operational workers are listed only when enabled for the deployment.
...
- `src/app/user`: account and settings UI
