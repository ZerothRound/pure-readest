...
const FoliateViewer: React.FC<{
  ...
  useEffect(() => {
    ...
    const openBook = async () => {
      ...
      const legadoLocation =
        !overrideLocation && !config.location && config.legadoProgress
          ? await cfiFromLegadoProgress(view, config.legadoProgress)
          : null;
      const lastLocation = overrideLocation ?? config.location ?? legadoLocation;
      if (lastLocation) {
